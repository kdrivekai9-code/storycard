...
export function mergeConfig(answers: StyleAnswers): InvitationConfig {
  ...
  return {
    ...
    coverTextFont: answers.coverTextFont ?? "pretendard",
    coverTextSize: answers.coverTextSize ?? 0,
    coverTextBgColor: answers.coverTextBgColor ?? "#ffffff",
    coverTextBgOpacity: answers.coverTextBgOpacity ?? 0,
    letteringText: answers.letteringText ?? "Our wedding day",
    letteringFont: answers.letteringFont ?? "great-vibes",
    letteringSize: answers.letteringSize ?? 18,
    letteringColor: answers.letteringColor ?? "#ffffff",
